                            ...
                            <div class="row align-items-center">
                                <div class="col-md-5">
                                    ...
                                    <div class="product-slider-single-nav normal-slider">
                                        <div class="slider-nav-img"><img src="{{ url('public/shop' )}}/img/product-1.jpg" alt="Product Image"></div>
                                        <div class="slider-nav-img"><img src="{{ url('public/shop' )}}/img/product-3.jpg" alt="Product Image"></div>
                                        <div class="slider-nav-img"><img src="{{ url('public/shop' )}}/img/product-5.jpg" alt="Product Image"></div>
                                        <div class="slider-nav-img"><img src="{{ url('public/shop' )}}/img/product-7.jpg" alt="Product Image"></div>
                                        <div class="slider-nav-img"><img src="{{ url('public/shop' )}}/img/product-9.jpg" alt="Product Image"></div>
                                        <div class="slider-nav-img"><img src="{{ url('public/shop' )}}/img/product-10.jpg" alt="Product Image"></div>
                                    </div>
                                </div>
                                <div class="col-md-7">
